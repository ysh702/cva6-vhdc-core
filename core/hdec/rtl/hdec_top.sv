...
module hdec_top import hdec_pkg::*; import hdec_resource_pkg::*; (
    ...
    logic [LANE_NUM-1:0][LANE_WIDTH-1:0] hbundle_lo_q,hbundle_lo_n,hbundle_hi_q,hbundle_hi_n;
    logic [VRF_IDX_W-1:0] hbundle_hv0_entry,hbundle_hv1_entry,hbundle_hv2_entry;
    ...
    logic [LANE_NUM-1:0][LANE_WIDTH-1:0] lane_bmca_lo,lane_bmca_hi;
    logic [LANE_NUM-1:0][7:0]            lane_bmca_count3;
    logic [LANE_NUM-1:0]                 lane_bmca_count_valid;
    logic [LANE_NUM-1:0]                 lane_bundle_valid;
    logic [LANE_NUM-1:0][15:0]           lane_bundle_lo_bits,lane_bundle_hi_bits;
    ...
    assign hsim_group_distance = {2'b0,lane_bmca_count3[0]} + {2'b0,lane_bmca_count3[1]} + {2'b0,lane_bmca_count3[2]} + {2'b0,lane_bmca_count3[3]};
    ...
    for (genvar lid = 0; lid < LANE_NUM; lid++) begin : gen_lane
        hdec_lane_4x64 #(.LANE_ID(lid)) i_lane (
            ...
            .bmca_hi_o(lane_bmca_hi[lid]),
            .bmca_count3_o(lane_bmca_count3[lid]),
            ...
            .bundle_hi_bits_i(lane_bundle_hi_bits[lid]),
    ...
    always_comb begin
        ...
        hbundle_base_n=hbundle_base_q; hbundle_acc_sel_n=hbundle_acc_sel_q; hbundle_chunk_n=hbundle_chunk_q; hbundle_lo_n=hbundle_lo_q; hbundle_hi_n=hbundle_hi_q;
        lane_bool_valid='0;
        ...
        lane_bundle_valid='0; lane_bundle_lo_bits='0; lane_bundle_hi_bits='0;
        lane_shift_valid='0;
        ...
        S_HSIM_LOAD: begin
            ...
            if((chunk_cnt_q==2'd3)||(hsim_row_q==2'd2))begin
        ...
        S_HBUNDLE3_UPDATE_SUB0: begin
            ...
            lane_bundle_hi_bits[0]=hbundle_hi_q[0][15:0]; lane_bundle_hi_bits[1]=hbundle_hi_q[1][15:0]; lane_bundle_hi_bits[2]=hbundle_hi_q[2][15:0]; lane_bundle_hi_bits[3]=hbundle_hi_q[3][15:0];
            vrf_we='1;
        ...
        S_HBUNDLE3_UPDATE_SUB1: begin
            ...
            lane_bundle_hi_bits[0]=hbundle_hi_q[0][31:16]; lane_bundle_hi_bits[1]=hbundle_hi_q[1][31:16]; lane_bundle_hi_bits[2]=hbundle_hi_q[2][31:16]; lane_bundle_hi_bits[3]=hbundle_hi_q[3][31:16];
            vrf_we='1;
        ...
        S_HBUNDLE3_UPDATE_SUB2: begin
            ...
            lane_bundle_hi_bits[0]=hbundle_hi_q[0][47:32]; lane_bundle_hi_bits[1]=hbundle_hi_q[1][47:32]; lane_bundle_hi_bits[2]=hbundle_hi_q[2][47:32]; lane_bundle_hi_bits[3]=hbundle_hi_q[3][47:32];
            vrf_we='1;
        ...
        S_HBUNDLE3_UPDATE_SUB3: begin
            ...
            lane_bundle_hi_bits[0]=hbundle_hi_q[0][63:48]; lane_bundle_hi_bits[1]=hbundle_hi_q[1][63:48]; lane_bundle_hi_bits[2]=hbundle_hi_q[2][63:48]; lane_bundle_hi_bits[3]=hbundle_hi_q[3][63:48];
            vrf_we='1;
