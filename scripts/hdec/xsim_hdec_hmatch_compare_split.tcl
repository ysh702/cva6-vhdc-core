...
set tb_file   [file join $repo_root "verif" "hdec" "tb_hdec_hmatch_compare_split.sv"]
set run_dir   [file join $out_root "xsim_hmatch_compare_split"]
...
exec xelab tb_hdec_hmatch_compare_split -s tb_hdec_hmatch_compare_split
...
exec xsim tb_hdec_hmatch_compare_split -tclbatch $sim_tcl
