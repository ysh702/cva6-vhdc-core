...
set tb_file   [file join $repo_root "verif" "hdec" "tb_hdec_cvxif_smoke_vv24.sv"]
set run_dir   [file join $out_root "xsim_cvxif_smoke_vv24"]
...
exec xelab tb_hdec_cvxif_smoke_vv24 -s tb_hdec_cvxif_smoke_vv24
...
exec xsim tb_hdec_cvxif_smoke_vv24 -tclbatch $sim_tcl
