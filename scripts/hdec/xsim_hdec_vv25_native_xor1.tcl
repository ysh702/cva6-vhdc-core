...
set tb_file   [file join $repo_root "verif" "hdec" "tb_hdec_vv25_native_xor1.sv"]
set run_dir   [file join $out_root "xsim_vv25_native_xor1"]
...
exec xelab tb_hdec_vv25_native_xor1 -s tb_hdec_vv25_native_xor1
...
exec xsim tb_hdec_vv25_native_xor1 -tclbatch $sim_tcl
