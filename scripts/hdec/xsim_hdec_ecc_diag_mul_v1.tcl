...
set tb_file   [file join $repo_root "verif" "hdec" "tb_hdec_ecc_diag_mul_v1.sv"]
set run_dir   [file join $out_root "xsim_ecc_diag_mul_v1"]
...
exec xelab tb_hdec_ecc_diag_mul_v1 -s tb_hdec_ecc_diag_mul_v1
...
exec xsim tb_hdec_ecc_diag_mul_v1 -tclbatch $sim_tcl
