...
set tb_file   [file join $repo_root "verif" "hdec" "tb_hdec_hperm_bit_align.sv"]
set run_dir   [file join $out_root "xsim_hperm_bit_align"]
...
exec xelab tb_hdec_hperm_bit_align -s tb_hdec_hperm_bit_align
...
exec xsim tb_hdec_hperm_bit_align -tclbatch $sim_tcl
