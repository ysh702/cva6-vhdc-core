...
set tb_file   [file join $repo_root "verif" "hdec" "tb_hdec_ecc_pmul_v18.sv"]
set run_dir   [file join $out_root "xsim_ecc_pmul_v18"]
...
exec xelab tb_hdec_ecc_pmul_v18 -s tb_hdec_ecc_pmul_v18
...
exec xsim tb_hdec_ecc_pmul_v18 -tclbatch $sim_tcl
