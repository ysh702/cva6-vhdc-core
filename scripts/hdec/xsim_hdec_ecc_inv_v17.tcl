...
set tb_file   [file join $repo_root "verif" "hdec" "tb_hdec_ecc_inv_v17.sv"]
set run_dir   [file join $out_root "xsim_ecc_inv_v17"]
...
exec xelab tb_hdec_ecc_inv_v17 -s tb_hdec_ecc_inv_v17
...
exec xsim tb_hdec_ecc_inv_v17 -tclbatch $sim_tcl
