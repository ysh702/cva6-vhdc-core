...
set tb_file   [file join $repo_root "verif" "hdec" "tb_hdec_hdc_full_flow_v20.sv"]
set run_dir   [file join $out_root "xsim_hdc_full_flow_v20"]
...
exec xelab tb_hdec_hdc_full_flow_v20 -s tb_hdec_hdc_full_flow_v20
...
exec xsim tb_hdec_hdc_full_flow_v20 -tclbatch $sim_tcl
