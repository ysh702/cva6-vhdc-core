...
set tb_file   [file join $repo_root "verif" "hdec" "tb_hdec_ecc_pmul_bg_v27.sv"]
set run_dir   [file join $out_root "xsim_ecc_pmul_bg_v27"]
...
exec xelab tb_hdec_ecc_pmul_bg_v27 -s tb_hdec_ecc_pmul_bg_v27
...
exec xsim tb_hdec_ecc_pmul_bg_v27 -tclbatch $sim_tcl
