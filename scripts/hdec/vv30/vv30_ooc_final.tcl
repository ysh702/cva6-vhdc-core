# Vivado 2024.2 matched OOC synthesis for the cumulative VV30 RTL.
#
# Usage:
#   vivado -mode batch -source vv30_ooc_final.tcl -tclargs \
#     <repo_root> <out_root> <period_ns> <label>

if {$argc != 4} {
    error "Expected: <repo_root> <out_root> <period_ns> <label>"
}
