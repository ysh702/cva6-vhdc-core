...
set tb_file   [file join $repo_root "verif" "hdec" "tb_hdec_ecc_pmul_bg_hdc_loop_v31.sv"]
set run_dir   [file join $out_root "xsim_ecc_pmul_bg_hdc_loop_v31"]
...
exec xelab tb_hdec_ecc_pmul_bg_hdc_loop_v31 -s tb_hdec_ecc_pmul_bg_hdc_loop_v31
...
exec xsim tb_hdec_ecc_pmul_bg_hdc_loop_v31 -tclbatch $sim_tcl
